...
export type PatronPelaje = 'solido' | 'atigrado' | 'manchado' | 'bicolor'
...
export function CatAvatar({
  ...
  return (
    ...
    >
      {/* Orejas */}
      <path d="M22 34 L14 10 L38 26 Z" fill={piel} />
      <path d="M78 34 L86 10 L62 26 Z" fill={piel} />
      ...
      {/* Ojos */}
      <ellipse cx="38" cy="54" rx="4.5" ry="6" fill="#4A3C36" />
      <ellipse cx="62" cy="54" rx="4.5" ry="6" fill="#4A3C36" />
